...
yystate(34, [C|Ics], Line, Tlen, _, _) when C >= 97, C =< 107 ->
    yystate(9, Ics, Line, Tlen+1, 2, Tlen);
yystate(34, [C|Ics], Line, Tlen, _, _) when C >= 109, C =< 113 ->
    yystate(9, Ics, Line, Tlen+1, 2, Tlen);
...
yystate(19, [C|Ics], Line, Tlen, _, _) when C >= 65, C =< 90 ->
    yystate(9, Ics, Line, Tlen+1, 2, Tlen);
yystate(19, [C|Ics], Line, Tlen, _, _) when C >= 97, C =< 120 ->
    yystate(9, Ics, Line, Tlen+1, 2, Tlen);
...
yystate(13, [C|Ics], Line, Tlen, _, _) when C >= 97, C =< 103 ->
    yystate(9, Ics, Line, Tlen+1, 2, Tlen);
yystate(13, [C|Ics], Line, Tlen, _, _) when C >= 105, C =< 111 ->
    yystate(9, Ics, Line, Tlen+1, 2, Tlen);
...
yystate(6, [C|Ics], Line, Tlen, Action, Alen) when C >= 65, C =< 90 ->
    yystate(9, Ics, Line, Tlen+1, Action, Alen);
yystate(6, [C|Ics], Line, Tlen, Action, Alen) when C >= 98, C =< 100 ->
    yystate(9, Ics, Line, Tlen+1, Action, Alen);
yystate(6, [C|Ics], Line, Tlen, Action, Alen) when C >= 102, C =< 111 ->
    yystate(9, Ics, Line, Tlen+1, Action, Alen);
yystate(6, [C|Ics], Line, Tlen, Action, Alen) when C >= 118, C =< 122 ->
    yystate(9, Ics, Line, Tlen+1, Action, Alen);
...
yyaction_2(TokenChars, TokenLine) ->
     { token, { spotify_id, TokenLine, TokenChars } } .
